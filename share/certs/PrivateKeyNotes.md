...
unlocked to sign the Goldbit-Qt.app bundle.
...
allowing somebody to distribute a Goldbit-Qt.app or goldbit-qt-setup.exe with a valid
...
that the goldbit-qt.exe file inside the installer had not been tampered with.

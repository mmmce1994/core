...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/goldbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Goldbit Core"),
     ...
     * override -datadir in the goldbit.conf file in the default data directory
     * (to be consistent with goldbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())

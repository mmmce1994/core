...
#ifndef GOLDBIT_QT_GOLDBITUNITS_H
#define GOLDBIT_QT_GOLDBITUNITS_H
...
/** Goldbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GoldbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GoldbitUnits(QObject *parent);

    /** Goldbit units.
      @note Source: https://en.goldbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GBT,
...
private:
    QList<GoldbitUnits::Unit> unitlist;
};
typedef GoldbitUnits::Unit GoldbitUnit;

#endif // GOLDBIT_QT_GOLDBITUNITS_H

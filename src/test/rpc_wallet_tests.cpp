...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CGoldbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CGoldbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CGoldbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CGoldbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CGoldbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CGoldbitAddress(arr[0].get_str()).Get() == demoAddress.Get());

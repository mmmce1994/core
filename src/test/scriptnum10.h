...
#ifndef GOLDBIT_TEST_SCRIPTNUM10_H
#define GOLDBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Goldbit Core 0.10.0, for cross-comparison.
 */
public:

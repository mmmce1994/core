...
This document provides guidelines for internationalization of the Goldbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `goldbit_en.ts` remains unchanged.

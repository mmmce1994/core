Goldbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/goldbit/files/Goldbit/goldbit-0.5.4/
...
http://gitorious.org/goldbit/goldbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Goldbit-Qt notifications under Growl 1.3.
Increase required age of Goldbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGoldbit properly when installing Goldbit-Qt over it. (Windows)

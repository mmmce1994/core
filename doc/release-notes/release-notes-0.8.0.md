Goldbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/goldbit/files/Goldbit/goldbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Goldbit
...
New/changed settings (command-line or goldbit.conf file)
--------------------------------------------------------

Goldbit Core version 0.9.4 is now available from:

  https://goldbit.org/bin/0.9.4/
...
this update is incompatible with the Goldbit system and could lead to consensus
forks.

Goldbit Core released binaries from https://goldbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~goldbit/+archive/ubuntu/goldbit
- A third-party or self-compiled Goldbit Core

upgrade to Goldbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
